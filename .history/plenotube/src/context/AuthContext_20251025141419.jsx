...
export const AuthProvider = ({ children }) => {
    ...
    return (
        <AuthContext.Provider value={{ ...state, isOtp,isAuthenticated, userInfo, loading, token, dispatch, handleRegister, handleRegisterViaGoogle, handleLogout, handleOtp, handleLogin }}>
            {children}

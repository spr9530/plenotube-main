    ...
    return (
        <SettingLayout>
            ...
            <div className='flex flex-col gap-2'>
                ...
                <div className='grid grid-cols-12 gap-3'>
                    <div className='col-span-4'>
                        <Button size='lg' isLoading={loading} className='bg-zinc-900 border border-zinc-800 w-full flex gap-1 justify-between align-items-center p-3'
                            onClick={(e) => {
                                handleGenerateKey(e, 'Instagram');
                                setHeading('Add this security key in you bio')
            ...
            <AccountModel modal={modal} setModal={setModal}
                ...
                description={description} setDescription={setDescription} securityKey={securityKey} setSecurityKey={setSecurityKey} />
        </SettingLayout>
    )
}

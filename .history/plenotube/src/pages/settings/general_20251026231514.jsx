...
function General() {
    ...
    const { getUserGeneral, updateUserGeneral, genrateMailChangeOtp, verifyOtp, genrateSecurityKey, user, updateUserPassword, loading: userLoading } = useUser();
    ...
    const handlePassword = async (e) => {
        e.preventDefault();
        const res = await genrateSecurityKey();
        setEditPassword(res);
    }
                        ...
                        <div className='flex justify-between items-center w-full gap-3'>
                            ...
                            <div className='flex gap-2 mt-7'>
                                ...
                                {editPassword ? <>
                                    ...
                                    <Button isIconOnly variant='light' size='lg' color='primary' isLoading={userLoading} className='text-xl' onClick={(e) => {
                                        if (!user?.password) {
                                            handlePassword(e);
                                        } else {

                ...
                <>
                    <div className='flex flex-col gap-8 h-full max-h-100 overflow-auto custom-scroll'>
                        ...
                        <div className='flex justify-between items-center w-full gap-3'>
                           ...
                           {editEmail && 
                            <div className='flex flex-col justify-start w-[70%]'>
                                <label htmlFor="useremail" className='text-sm mb-2 font-semibold'>OTP <span className='text-red-500'>*</span></label>
                            ...
                            <div className='flex gap-2 mt-7'>
                                ...
                                {editEmail ? <>
                                    ...
                                    :
                                    <Button isIconOnly variant='light' size='lg' color='primary' className='text-xl' onClick={() => setEditEmail(true)}>
                                        <RiPencilFill />
                                    </Button>
                                }
                            </div>

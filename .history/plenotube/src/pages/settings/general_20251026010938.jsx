...
function General() {
    ...
    const { getUserGeneral, updateUserGeneral,genrateMailChangeOtp, user, loading: userLoading } = useUser();
                        ...
                        <div className='flex justify-between items-center w-full gap-3'>
                            ...
                            {editEmail && (
                                <div className='flex flex-col justify-start w-[70%]'>
                                    ...
                                    <InputOtp  length={6} size='sm' className='-mt-3' isDisabled={isInvalid} />
                                </div>
                            )}
                            ...
                            <div className='flex gap-2 mt-7'>
                                {editEmail ? (
                                    <>
                                        <Button isIconOnly variant='flat' size='lg' color='primary' isDisabled={isInvalid} onClick={(e)=> handleGenrateOtp(e)}>

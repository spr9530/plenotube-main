                        ...
                        <div className='flex justify-between items-center w-full gap-3'>
                            <div className='flex flex-col justify-start w-[70%]'>
                                ...
                                <Input
                                    ...
                                    value={email}
                                    isInvalid={isInvalid}
                                    className='bg-[#111] rounded-xl outline-none border ${isInvalid ? border-zinc-800}'
                                />
                            </div>
                            ...
                            {editEmail && (
                                <div className='flex flex-col justify-start w-[70%]'>
                                    ...
                                    <InputOtp  length={6} size='sm' className='-mt-3' />
                                </div>
                            )}
                            ...
                            <div className='flex gap-2 mt-7'>
                                {editEmail ? (
                                    <>
                                        <Button isIconOnly variant='flat' size='lg' color='primary' isDisabled={isInvalid}>

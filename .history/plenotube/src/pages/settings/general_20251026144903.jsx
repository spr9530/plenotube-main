...
function General() {
    ...
    const handleGenrateOtp = (e) =>{
        e.preventDefault();
        if(email!=''){
            const res = genrateMailChangeOtp({email});
            setIsVerify(res);
        }else{
                    ...
                    <div className='flex flex-col gap-8 h-full max-h-100 overflow-auto custom-scroll'>
                        ...
                        <div className='flex justify-between items-center w-full gap-3'>
                            ...
                            <div className='flex gap-2 mt-7'>
                                {editEmail ? (
                                    <>
                                        <Button isIconOnly variant='flat' size='lg' color='primary' isLoading={userLoading} isDisabled={isInvalid} onClick={(e)=> isVerify? verifyEmialChange(e): handleGenrateOtp(e)}>
                                           <span className='font-semibold text-sm'>{isVerify? 'Verify' :'Send'}</span>
                                        </Button>
                                        <Button
                                            isIconOnly
                                            variant='flat'

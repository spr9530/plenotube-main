            ...
            <div className='h-full w-full flex items-center justify-center p-2'>
                {
                    isOtp ?
                        ...
                        fillUserName ?
                            <form onSubmit={handleSubmit(submitOtp)} classname='w-100 h-100 min-h-[80vh] min-w-[30vw]'>
                                <Card className='h-full w-full flex flex-col w-full lg:max-w-[30vw] items-center justify-center p-3 py-5 gap-4'>
                                    <div className='w-full flex flex-col items-center justify-center gap-2 mb-2'>
                                        <SiSimplenote className='text-xl font-semibold' />
                                        <h1 className='text-xl font-semibold'>PlenoTube</h1>
                                        <h2 className='text-md font-medium flex gap-2 items-center'> <FaUserCircle /> Choose A Username</h2>
                                        {authError && <span className='text-danger text-sm ml-1'>{authError}</span>}
                                    </div>
                                    <div className='flex flex-col w-full gap-4'>
                                        <div className='w-full flex flex-col items-center'>
                                            <label htmlFor='full-name' className='mb-1 font-medium ml-1'>Username <span className='text-danger'>*</span></label>
                                            <div className="flex w-full flex-wrap md:flex-nowrap gap-4 items-center justify-center">
                                                <Input
                                                    id='username'
                                                    type='text'
                                    ...
                                    <div className='flex flex-col w-full gap-4'>
                                        ...
                                        <div className='w-full flex flex-col '>
                                            <label htmlFor='username' className='mb-1 font-medium ml-1'>
                                                Username <span className='text-danger'>* <span>{errors.username && (

...
function SignIn() {
    ...
    const { handleRegisterViaGoogle,handleLogin, user, loading: authLoading, error: authError } = useAuth();
    ...
    const submitDetails = (data) => handleLogin({...data})
    ...
    return (
        <DefaultLayout>
            <div className='h-full w-full flex items-center justify-center p-2'>
                <Card className='h-full flex flex-col w-full lg:max-w-[30vw] items-center p-3 py-5 gap-4'>
                    ...
                    <form onSubmit={handleSubmit(submitDetails)} className='w-full h-full flex flex-col justify-evenly'>

...
const { createNewCampaign, getCampaigns, getUserCampaigns, getCamapaignInfo } = require('./campaign.controller');
...
campaign_router.get('/get-campaigns',authenticate,  getCampaigns);
campaign_router.get('/get-campaign-info/:id',authenticate, getCamapaignInfo )
